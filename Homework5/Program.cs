...
// Create new event
var event1 = new Event("Some Event for Highschool Volunteer", "Central Park", new DateTime(2023, 8, 30, 13, 00, 00));
...
public class Event
{
    ...
    public Event(string eventName, string eventLocation, DateTime eventDateTime)
    {
        EventName = eventName;
